...
path = "C:/Users/Itzli/Downloads/Req.xls"
...
text = "Hola!\nLe enviamos archivo con información provista por ICE\n"
html = """\
...
<th class="expander"></th>
      ...
      <table>
        <tr>
          <th>
                  <center data-parsed="">
                  <img src="{{site}}{% static 'images/logo.png' %}" valign="bottom" alt="Masthead Image" align="center" class="text-center" style="max-height:250px; !important:">
                  </center>
                </th>
<th class="expander"></th>
        </tr>
...
<th class="expander"></th>
      ...
      <table>
        <tr>
          <th>
                <h3>Saludos</h3>
                  <p>A continuación encontrarás un listado con la información provista por el 'ICE':</p>
                  <br>
                  <h5>Remolque: {{trailer}}</h5>
...
<th class="expander"></th>
              ...
              <table class="row show-for-large"><tbody><tr class="tr-head"> <!-- Receipt Header. Hidden for mobile--> 
...
<th class="expander"></th>
      ...
      <table>
        <tr>
          <th>
                <a href="http://digimundo.com.mx" target="_blank"><p class="text-center footercopy">&#xA9; Copyright 2018 DIGIMUNDO TECHNOLOGIES. All Rights Reserved.</p></a>
...
part.set_payload(open("C:/Users/Itzli/Downloads/Req.xls", "rb").read())
encoders.encode_base64(part)
part.add_header('Content-Disposition', 'attachment; filename="Prueba.xls"')
msg.attach(part)
